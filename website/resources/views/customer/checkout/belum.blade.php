    ...
    <div class="row">
        ...
        <div class="menu-kanan col-10 mt-5">
            <div class="row">
                ...
                <form action="/proses_bayar-{{ $akses_keranjang->id }}" method="post">
                    @csrf
                    <div class="col-10 offset-1">
                        <div class="container bungkus mt-3" style="border-radius: 25px;">
                            ...
                            <!-- Akhir Ket-Produk -->
                            <div class="row pt-4 pb-3 mb-5" style="border-bottom: 3px dashed #DAA7A7;">
                            ...
                            <div class="row py-3 text-white">
                                ...
                                <div class="col-2 me-3">
                                    <select id="pilihPembayaran" class="form-select" name="pilih_pembayaran"
                                        aria-label="Default select example">
                            ...
                            <div class="row pt-5 mt-2">
                                <div class="col-2 ps-5 ms-auto">
                                    <button type="submit" style="background: transparent; border: 0;">
                                        <a class="btn btn-custom ms-5 ms-auto text-white">
                                            Buat Pesanan
                                        </a>
                                    </button>
                                </div>
