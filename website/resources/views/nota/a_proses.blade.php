        ...
        <div class="menu-kanan col-10 mt-5">
            <div class="row">
                <div class="col-10 offset-1">
                    ...
                    <form action="/a-nota-{{ $riwayats[0]->id }}to_d" method="post">
                        @csrf
                        <div class="container bungkus mt-3" style="border-radius: 25px;">
                                    ...
                                    <div class="container pt-3">
                                        ...
                                        <ul class="d-flex justify-content-between align-content-center list-judul">
                                            ...
                                            <li class="">
                                                ...
                                                <form action="/ulasan-produk{id}" method="post">
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content p-3">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    {{-- Rate Produk --}}
                                                                    <div
                                                                        class="rate-produk d-flex justify-content-between">
                            ...
                            <div class="row ps-5 py-3 res-tran text-white">
                                ...
                                <div class="col-12">
                                    <h6 class="d-inline me-3">Masukkkan No. Resi:</h6>
                                    <input type="text" name="no_resi"
                                        style="outline: none; border-radius: 8px; border: 1px solid white; color: white; padding: 5px; background-color: transparent"
