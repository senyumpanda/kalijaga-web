...
<head>
    ...
    <title>admin - pesananku (dikirim)</title>
                            ...
                            <ul class="">
                                ...
                                <li class="awal">
                                    ...
                                    <ul>
                                        ...
                                        <li class="kedua g-0">
                                            <i class="bi bi-caret-right-fill"></i>
                                            <a href="pesananku.php" class="aktif">Pesananku</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                                ...
                                <div class="col-10 offset-1">
                                    <div class="container pt-3">
                                        <ul class="d-flex justify-content-around align-content-center list-judul">
                                            <li>
                                                <a href="pesananku-1.php" class="aktif">Dikirim</a>
                                            </li>
                                            <li>
                                                <a href="pesananku-2.php">Selesai</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="barang pt-3">
                                        <div class="row text-white">
                                            <div class="col-2 d-flex align-content-center justify-content-center pt-2">
                                                <img src="../img/parfum.png" style="width: 100px; height: 120px;"
                                                    alt="">
                                            </div>
                                            <div class="col-6">
